...
{
	//переменные
	//value = результат побитового "xor", которое нужно записать в регистр (3 арг)
	//value_1
	//value_2
	...
	// 2 числа побитово преобразуем: value = value_1 ^ value_2;
	...
	//печать ft_printf("P %4d | xor %d %d r%d\n", cursor_id, value_1, value_2, r_id);
}